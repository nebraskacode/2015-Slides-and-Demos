Slidedeck for the Nebraska.Code() session on Service Oriented Architecture ( http://nebraskacode.com/sessions/service-oriented-architecture ) by Tim Kinker and Marco Rentier.
